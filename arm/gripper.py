...
DEFAULT_LOAD_THRESHOLD = 120   # 0..1000 (холостой максимум 28, контакт от ~344)
...
DEFAULT_CONFIRM = 2            # подряд идущих подтверждений (защита от выброса)
DEFAULT_EXTRA_SQUEEZE = 2.0    # лёгкий дожим после контакта, чтобы держало
