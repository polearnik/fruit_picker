...
Подготовка: яркая КРАСНАЯ метка (шарик/колпачок) ровно на кончике руки.
Диапазоны красного в HSV заданы ниже (MARKER_HSV_RANGES).
...
# Цвет метки — КРАСНЫЙ. В HSV красный разорван на два конца шкалы тона
# (H≈0 и H≈180), поэтому берём два диапазона и объединяем их маски.
MARKER_HSV_RANGES = [
